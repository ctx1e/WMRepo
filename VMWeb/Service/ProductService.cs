    ...
    public class ProductService
    {
        ...
        public async Task<bool> AddProductAsync(Product product)
        {
            try
            {
                ...
                var response = await _httpClient.PostAsync($"{API_URL}/AddProduct", content);
        ...
        public async Task<bool> UpdateProductAsync(Product product)
        {
            try
            {
                ...
                // Thêm dữ liệu sản phẩm vào content (product)
                content.Add(new StringContent(product.ProductId + ""), "ProductId");
                content.Add(new StringContent(product.ProductName), "ProductName");
                content.Add(new StringContent(product.Category), "Category");
                content.Add(new StringContent(product.Description), "Description");
        ...
        public async Task<bool> DeleteProductAsync(int productId)
        {
            try
            {
                ...
                var response = await _httpClient.DeleteAsync($"{API_URL}/deleteProduct/{productId}");
